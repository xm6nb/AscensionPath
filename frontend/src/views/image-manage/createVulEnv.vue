  ...
  >
        ...
        <div class="flex justify-center items-center gap-2 h-full" style="white-space: nowrap">
          <div class="bg-gradient-to-b from-stone-300/40 to-transparent p-[2px] rounded-[12px]">
            <button
              ...
              style="height: 2.8em; padding: 0.35em 1.2em 0.35em 1.2em"
              @click="submitUpload"
            >
    ...
    <el-dialog v-model="dialogCreateVulVisible" title="创建漏洞环境" width="800">
      <el-form
        ...
        :rules="rules"
        label-width="auto"
        class="demo-ruleForm custom-loading-svg"
        :size="formSize"
        status-icon
      ...
      >
        ...
        <el-form-item label="漏洞环境描述" prop="env_desc">
          <el-input
            v-model="ruleForm.env_desc"
            type="textarea"
            :autosize="{ minRows: 2, maxRows: 6 }"
            placeholder="最好描述一下漏洞环境吧😁"
            :resize="'none'"
          />
        </el-form-item>
