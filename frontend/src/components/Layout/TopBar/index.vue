    ...
    <div class="menu">
      ...
      <div class="right">
        ...
        <div class="user">
          ...
          >
            <template #reference>
              <img class="cover" :src="RandomJpgImg(userInfo.id || (Math.random() * 10))" />
            </template>
            <template #default>
              <div class="user-menu-box">
                <div class="user-head">
                  <img class="cover" :src="RandomJpgImg(userInfo.id || (Math.random() * 10))" style="float: left" />
                  <div class="user-wrap">
